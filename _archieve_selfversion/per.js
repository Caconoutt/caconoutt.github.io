function phoneSize(){
    if ($(window).width() < 450){
      ...
      $('#phoneBody').addClass('perMain');
      $('#phoneBody').css("margin-top", "3rem")
      $('.section-body').addClass('pSectionBody');
      $('.section-body').removeClass('section-body');
      $('#phoneText').css("margin-top","250px");
      ...
      //img
      $('#personalP1').removeClass('non-display');
      $('#personalP3').removeClass('non-display');
